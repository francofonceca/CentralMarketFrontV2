...
//import { useFormBranch } from './useFormBranch';
import { useForm } from '../../hooks/useForm';
import validateBranchInfo from './validateBranchInfo';
...
export const BranchOfficeForm = ({ closeModal }) => {
    ...
    const { handleChange, formState, handleSubmit, errors } = useForm( initialState, validateBranchInfo);
            ...
            <Row>
                <Col className='justify-content-md-center' xs='12'>
                    <Row className='px-5 py-3'>
                        <Form.Label className='text-form-sub-tittle'>Agregar Sucursal</Form.Label>
                    </Row>
                    ...
                    <Form  className='px-5 pb-3' onSubmit={handlePreSubmit}>
                        ...
                        <Row className='py-3'>
                            <Form.Label className='text-form-sub-tittle'> 
                                <img src ='images/icons/store-icon-black.svg' alt = 'BranchIcon' className="icon-black" />
                                Datos de Sucursal
                            </Form.Label>
                        </Row>
                        <Row>
                        ...
                        <GenericDataTable 
                            columns={ columns } 
                            tittle='Usuarios de la sucursal'
